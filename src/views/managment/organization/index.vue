    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <div class="text-center">
          <b-link :to="{ name: 'ViewOrganization',params : {id : item.id},query:{inn : item.inn}}"  v-b-tooltip.hover.top="$t('View')" style="margin-right : 5px">
...
<script>
import { BButton, BPagination, BTable, BCol, BRow, BSpinner, BCard, BTooltip, BBadge, BInputGroup, BFormInput, BInputGroupAppend,BLink,VBTooltip } from 'bootstrap-vue'
//import OrganizationService from "@/services/managment/organization.service";

export default {
  components : {
    BButton, BPagination, BTable, BCol, BRow, BSpinner, BCard, BTooltip, BBadge, BInputGroup, BFormInput, BInputGroupAppend,BLink
  },
  directives: {
    'b-tooltip': VBTooltip
  },

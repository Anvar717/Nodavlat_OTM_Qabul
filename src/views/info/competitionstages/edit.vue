            ...
            <b-col sm="12" md="6">
              <div class="form-group">
                ...
                <div>
                  <b-form-input
                    :placeholder="$t('code')"
                    v-model="CompetitionStages.code"
                  />
                </div>
              </div>
            </b-col>
                ...
                <div>
                  <b-input-group>
                    <b-form-input
                      ...
                      v-model="CompetitionStages.shortname"
                    />
                ...
                <div>
                  <b-input-group>
                    <b-form-input
                      ...
                      v-model="CompetitionStages.fullname"
                    />
                    <b-input-group-append>
                      <b-button
                        variant="primary"
              ...
              <div class="form-group">
                ...
                <div>
                  <v-select
                    ...
                    label="name"
                    v-model="CompetitionStages.stateid"
                  ></v-select>
                </div>
              </div>
            </b-col>
...
//import CompetitionStagesService from '@/services/info/CompetitionStages.service';
export default {
  components: {
    BOverlay,
    BCard,
  ...
  created() {
    ...
    // this.show = true;
    // CompetitionStagesService.Get(this.$route.params.id).then((res) => {
    //   this.show = false;
    //   this.CompetitionStages = res.data.result;
    // });
  ...
  methods: {
    check(){
            if (
                this.CompetitionStages.code === 0 ||
                this.CompetitionStages.code === null ||
                this.CompetitionStages.code === undefined ||
                this.CompetitionStages.code === ""
            ) {
                this.makeToast(
            ...
            if (
                this.CompetitionStages.shortname === 0 ||
                this.CompetitionStages.shortname === null ||
                this.CompetitionStages.shortname === undefined ||
                this.CompetitionStages.shortname === ""
            ) {
                this.makeToast(
            ...
            if (
                this.CompetitionStages.fullname === 0 ||
                this.CompetitionStages.fullname === null ||
                this.CompetitionStages.fullname === undefined ||
                this.CompetitionStages.fullname === ""
            ) {
                this.makeToast(
            ...
            if (
                this.CompetitionStages.stateid === 0 ||
                this.CompetitionStages.stateid === null ||
                this.CompetitionStages.stateid === undefined ||
                this.CompetitionStages.stateid === ""
            ) {
                this.makeToast(
    ...
    AddTranslate() {
      ...
      if (
        this.CompetitionStages.Translates.filter(
          (item) =>
      ...
      this.CompetitionStages.Translates.push(this.TranslateItem);
    ...
    GetTranslateItems(columnname) {
      this.TranslateItems = this.CompetitionStages.Translates.filter(

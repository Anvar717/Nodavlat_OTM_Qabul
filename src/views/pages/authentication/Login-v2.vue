  ...
  methods: {
    SignbyOneId() {
      if (this.isLocal) {
        ...
        let auth_token =
          "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIzMjgxMTk4NjEwMDAxNiIsImV4cCI6MTY5NDc2MTgyOSwiaWF0IjoxNjk0Njc1NDI5fQ.yJijVkMRRmrirrXgs3Uu2q_lxoz498ZVyWLvAj_PWiI";
